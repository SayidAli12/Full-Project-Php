...
$sql1 = "SELECT COUNT(id) AS returned FROM borrows WHERE status = 'returned' AND date BETWEEN '$date1' AND '$date2'";
                ...
                <div class="card p-1 mb-2 animate__animated animate__fadeIn">
                    <div class="btn-group">
                        ...
                        <a href="returned.php" class="btn btn-success m-2">
                            <i class="fas fa-undo-alt"></i>&nbsp;Returned Books&nbsp;:&nbsp;<?php echo $returned; ?>
                        </a>
